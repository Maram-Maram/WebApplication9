<%@ Page Title="Add Student" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="WebApplication9.AddStudent" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section>
        <div class="form-container">
            <asp:Panel runat="server" CssClass="add-student-form">
                <!-- User ID -->
                ...
                <!-- Submit Button -->
                <asp:Button ID="AddStudentButton" runat="server" Text="Add Student" CssClass="btn-primary" OnClick="AddStudentButton_Click" />
            </asp:Panel>
        </div>
    </section>
</asp:Content>
