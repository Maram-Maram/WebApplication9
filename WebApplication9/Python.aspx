<%@ Page Title="Python" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Python.aspx.cs" Inherits="WebApplication9.Python" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="course-details-container">
        ...
        <div class="video-container">
            <h2>Course Video</h2>
            <iframe src="https://www.youtube.com/watch?v=mvZHDpCHphk&list=PLDoPjvoNmBAyE_gei5d18qkfIe-Z8mocs" allowfullscreen></iframe>
        </div>
